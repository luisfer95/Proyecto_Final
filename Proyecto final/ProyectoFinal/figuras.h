...
class CFiguras
{
	...
	void prisma3(float altura, float largo, float profundidad, GLuint text1, GLuint text2, GLuint text3, GLuint text4, GLuint text5, GLuint text6);//Funcíon creacion prisma
